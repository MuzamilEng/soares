...
const Sidebar = () => {
  return (
    <aside className='w-full max-w-[17vw] p-[1vw] h-screen bg-[#ffff]'>
    ...
    <section className='mt-[2vw]'>
        {sidebar?.map((item, index) => (
            <Link to={item?.path} key={index} className='flex hover:bg-[#6930C0] text-[#A5A4A4] rounded-md hover:text-white items-center p-[0.8vw]'>
