...
const DgLogin = () => {
  return (
    <main className="w-full h-screen relative">
      ...
      <h1 className='font-extrabold text-[5vw] md:text-[1vw] lg:text-[1vw] xl:text-[1vw] text-[#4B4752] mt-[2vw] order-2 sm:order-1 md:order-1 lg:order-2 xl:order-2'>Acesso DGLAB</h1>
